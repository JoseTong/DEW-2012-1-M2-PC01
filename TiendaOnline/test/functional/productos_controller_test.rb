...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { codproducto: @producto.codproducto, descripcion: @producto.descripcion, precio: @producto.precio }
    end
  ...
  test "should update producto" do
    put :update, id: @producto, producto: { codproducto: @producto.codproducto, descripcion: @producto.descripcion, precio: @producto.precio }
    assert_redirected_to producto_path(assigns(:producto))
  end
